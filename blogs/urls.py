...
from blogs.views import homepage, user_create_list, user_retrieve_update, blog_category_create_list, blog_category_retrieve_update, blog_tag_create_list, blog_tag_retrieve_update
